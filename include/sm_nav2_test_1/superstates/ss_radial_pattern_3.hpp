...
struct SsRadialPattern3
    : smacc2::SmaccState<SsRadialPattern3, MsIsaacExplorationRunMode,
                         StiRadialLoopStart> {
public:
  using SmaccState::SmaccState;

  // TRANSITION TABLE
  typedef mpl::list<Transition<EvLoopEnd<StiRadialLoopStart>,
                               StNavigateWarehouseWaypointsX, ENDLOOP> //,

                    // Transition<EvLoopEnd<StiRadialLoopStart>,
                    // StRotateDegrees4, ENDLOOP>
